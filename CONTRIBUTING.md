...
Ensure that every function in `carpenterd-worker` is documented and follows the standards set by [JSDoc]. Finally,
...
[issues]: https://github.com/godaddy/carpenterd-worker/issues
